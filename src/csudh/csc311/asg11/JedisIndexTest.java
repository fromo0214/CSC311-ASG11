...
public class JedisIndexTest {
	...
	private static void loadIndex(JedisIndex index) throws IOException {
		...
		url1 = "https://raw.githubusercontent.com/behollister/fixed-wiki-pages/main/Java_(programming_language)";
		Elements paragraphs = wf.fetchWikipedia(url1);
		index.indexPage(url1, paragraphs);

		url2 = "https://raw.githubusercontent.com/behollister/fixed-wiki-pages/main/Programming_language";
